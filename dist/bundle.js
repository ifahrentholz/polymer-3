...
exports.updateStyles = exports.registrations = exports.instanceCount = exports.ElementMixin = void 0;
...
var caseMap$0 = _interopRequireWildcard(__webpack_require__(/*! ../utils/case-map.js */ "./node_modules/@polymer/polymer/lib/utils/case-map.js"));
...
var caseMap = _interopRequireWildcard(__webpack_require__(/*! ../utils/case-map.js */ "./node_modules/@polymer/polymer/lib/utils/case-map.js"));
...
exports.flush = exports.enqueueDebouncer = void 0;
...
exports.setPassiveTouchGestures = exports.passiveTouchGestures = exports.setSanitizeDOMValue = exports.sanitizeDOMValue = exports.setRootPath = exports.rootPath = exports.useNativeCustomElements = exports.useNativeCSSProperties = exports.useShadow = void 0;
...
function (_base) {
  function TemplateInstanceBase(props) {
    ...
    for (var n = _this.root.firstChild; n; n = n.nextSibling) {
      children.push(n);
      n.__templatizeInstance = _assertThisInitialized(_assertThisInitialized(_this));
    }
...
__webpack_require__(/*! ../headline/headline */ "./src/components/headline/headline.js");

var _card = _interopRequireDefault(__webpack_require__(/*! ./card.scss */ "./src/components/card/card.scss"));
...
var _headline = _interopRequireDefault(__webpack_require__(/*! ./headline.scss */ "./src/components/headline/headline.scss"));
...
function (_PolymerElement) {
  ...
  _createClass(Headline, null, [{
    ...
    key: "template",
    get: function get() {
      return (0, _polymerElement.html)(["\n      <style>".concat(_headline.default, "</style>\n      <h1>[[text]]</h1>\n    ")]);
    }
  }]);

  _inherits(Headline, _PolymerElement);
...
var _settings = __webpack_require__(/*! @polymer/polymer/lib/utils/settings */ "./node_modules/@polymer/polymer/lib/utils/settings.js");

var _page = _interopRequireDefault(__webpack_require__(/*! ./templates/page.html */ "./src/templates/page.html"));

__webpack_require__(/*! ./components/card/card */ "./src/components/card/card.js");
...
/*#__PURE__*/
function (_PolymerElement) {
  _createClass(StartPolymer3, null, [{
    key: "properties",
    get: function get() {
      return {
        message: {
  ...
  function StartPolymer3() {
    var _this;

    _classCallCheck(this, StartPolymer3);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(StartPolymer3).call(this)); // Resolve warning about scroll performance
    // See https://developers.google.com/web/updates/2016/06/passive-event-listeners

    (0, _settings.setPassiveTouchGestures)(true);
    _this.message = 'Hello World! I\'m a Polymer element :)';
    return _this;
  }

  _createClass(StartPolymer3, [{
    key: "ready",
    value: function ready() {
      _get(_getPrototypeOf(StartPolymer3.prototype), "ready", this).call(this);
    }
  }], [{
    key: "template",
    get: function get() {
      return (0, _polymerElement.html)(["".concat(_page.default)]);
    }
  }]);

  _inherits(StartPolymer3, _PolymerElement);

  return StartPolymer3;
}(_polymerElement.PolymerElement); // Register the element with the browser.
...
module.exports = "<h1>Start Polymer 3.0.2</h1> <p>[[message]]</p> <card-element></card-element>";
